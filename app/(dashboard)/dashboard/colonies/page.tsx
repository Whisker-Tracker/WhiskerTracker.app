...
export default async function ColoniesPage() {
  ...
  const coloniesT = messages_es.colonies as Record<string, string>;
        ...
        <div className="mt-4">
          <ColonyMap
            ...
            labels={{
              ...
              statusUnaltered: messages_es.cats.tnrStatusUnaltered,
              statusTrapped: messages_es.cats.tnrStatusTrapped,
              statusNeuteredSpayed: messages_es.cats.tnrStatusNeutered,
              statusEartipped: messages_es.cats.tnrStatusEartipped,
            }}
          />
        </div>
      </Card>
